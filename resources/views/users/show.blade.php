            ...
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    @can('user-profile-edit')
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('users.edit.password', withLang())}}">
                    ...
                    <div class="card-body">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="date" value="{{ old('dob', $user->employee->gender ?? '')}}" id="dob" />
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="date" value="{{ old('start_working_date', $user->employee->start_working_date ?? '')}}" id="start-working-date" />
                                </div>
                            </div>
                            <div class="mt-2">
