                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 col-md-12">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="position-relative">
                                        <img id="previewImage"
                                            src="{{ $product->image ? asset('images/product/' . $product->image) : asset('assets/img/blank-product.svg') }}"
                                            alt="Product"
                                            class="rounded"
                                            width="100"
                                            height="100"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control @error('product_name') is-invalid @enderror" type="text" value="{{ old('product_name', $product->product_name) }}" id="product_name" name="product_name" required>
                                    @error('product_name')
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control @error('product_imei') is-invalid @enderror" type="text" value="{{ old('product_imei', $product->product_imei) }}" id="product_imei" name="product_imei" required>
                                    @error('product_imei')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control @error('product_code') is-invalid @enderror" type="text" value="{{ old('product_code', $product->product_code) }}" id="product_code" name="product_code" required>
                                    @error('product_code')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select @error('condition') is-invalid @enderror" name="condition" id="condition" required>
                                        ...
                                        @foreach (\App\Models\Product::CONDITION as $id => $name)
                                            <option value="{{ $id }}" {{ old('condition', $product->condition) == $id ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select @error('brand_id') is-invalid @enderror" name="brand_id" id="brand_id" required>
                                        ...
                                        @foreach(\App\Models\Brand::pluck('name', 'id') as $id => $name)
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select @error('series_id') is-invalid @enderror" name="series_id" id="series_id" required>
                                        <option value="">Select an option</option>
                                        @foreach(\App\Models\Series::pluck('name', 'id') as $id => $name)
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select @error('model_type_id') is-invalid @enderror" name="model_type_id" id="model_type_id" required>
                                        <option value="">Select an option</option>
                                        @foreach(\App\Models\ModelType::pluck('name', 'id') as $id => $name)
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select @error('color_id') is-invalid @enderror" name="color_id" id="color_id" required>
                                        <option value="">Select an option</option>
                                        @foreach(\App\Models\Color::pluck('name', 'id') as $id => $name)
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select @error('storage_id') is-invalid @enderror" name="storage_id" id="storage_id" required>
                                        <option value="">Select an option</option>
                                        @foreach(\App\Models\Storage::pluck('name', 'id') as $id => $name)
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('type_of_machine') is-invalid @enderror" name="type_of_machine" id="type_of_machine" required>
                                                <option value="">Select an option</option>
                                                @foreach(\App\Models\Product::TYPE_OF_MACHINE as $id => $name)
                                                    <option value="{{ $id }}" {{ old('type_of_machine', $product->type_of_machine) == $id ? 'selected' : '' }}>
                                                        {{ $name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('network_id') is-invalid @enderror" name="network_id" id="network_id" required>
                                                <option value="">Select an option</option>
                                                @foreach(\App\Models\Network::pluck('name', 'id') as $id => $name)
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" class="form-control @error('percentage') is-invalid @enderror" id="percentage" name="percentage" value="{{ old('percentage', $product->percentage) }}">
                                        <span class="input-group-text">%</span>
                                    </div>
                                    @error('percentage')
                                        <span class="invalid-feedback" role="alert" style="display: block;"><strong>{{ $message }}</strong></span>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" class="form-control @error('purchase_price') is-invalid @enderror" id="purchase_price" name="purchase_price" value="{{ old('purchase_price', $product->purchase_price) }}" required>
                                        <span class="input-group-text">$</span>
                                    </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control @error('purchase_date') is-invalid @enderror" type="date" value="{{ old('purchase_date', $product->purchase_date ? \Carbon\Carbon::parse($product->purchase_date)->format('Y-m-d') : '') }}" id="purchase_date" name="purchase_date" required>
                                    @error('purchase_date')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" name="status" id="status" required>
                                        <option value="">Select an option</option>
                                        @foreach(\App\Models\Product::getStatuses() as $id => $name)
...
<script>
    ...
    document.getElementById('resetImageBtn').addEventListener('click', function() {
        ...
        document.getElementById('previewImage').src = "{{ $product->image ? asset('images/product/' . $product->image) : asset('assets/img/blank-product.svg') }}";
    });
</script>
@endpush